...
func (e *Error) Append(buf *bytes.Buffer, prefix string) {
	...
	if e.Summary != nil {
		buf.WriteByte('\t')
		buf.WriteString(str.IndentString(e.SummaryString(), prefix+"\t"))
	} else {
		buf.WriteString("\t     got: ")
		buf.WriteString(str.IndentString(e.GotString(), prefix+"\t          "))
		writeEolPrefix()
		buf.WriteString("\texpected: ")
		buf.WriteString(str.IndentString(e.ExpectedString(), prefix+"\t          "))
	}
...
func (e *Error) ExpectedString() string {
	...
	return str.ToString(e.Expected)
}
