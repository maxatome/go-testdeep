...
The simplest way to make use of the spew custom formatter is to call
one of the convenience functions such as spew.Printf,
spew.Println, or spew.Printf.  The functions have syntax you are
...
Since it is possible for custom Stringer/error interfaces to panic,
